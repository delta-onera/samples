...
def tonumpy4Dmask(mask):
    ...
    for r in range(imsize//vggpooling):
        for c in range(imsize//vggpooling):
            ...
            #print(str(imagenp4[0][0][r][c]),end=" ")
        #print("")
    return imagenp4
...
for epoch in range(nbepoch):
    ...
    for x,y in testdata:
        ...
        #print(targettensor.data.numpy())
        targettensor = targettensor.cuda()
        
        #print(outputtensor.cpu().data.numpy().shape)
        #print(targettensor.cpu().data.numpy().shape)
...
for x,y in testdata:
    ...
    for r in range(imsize//vggpooling):
        for c in range(imsize//vggpooling):
            ...
            print(str(int(10*(proba[0][1][r][c]-proba[0][0][r][c]))),end=" ")
        print("")
